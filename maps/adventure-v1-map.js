...
const objects=[
 ...
 prod('quarry-east','Kamieniołom',15,18,'stone',2,'🪨'),prod('sawmill-west','Tartak',8,20,'wood',2,'🪵'),prod('mercury-vat','Alchemiczna Cysterna',12,9,'mercury',1,'⚗️'),prod('sulfur-pit','Kopalnia Siarki',19,13,'sulfur',1,'🟡'),prod('gem-mine','Kopalnia Klejnotów',27,17,'gems',1,'💎'),prod('gold-mine-main','Opuszczona Kopalnia Złota',24,8,'gold',1000,'⛏️'),prod('soul-grove','Gaj Grzybów Dusz',6,8,'soulMushrooms',1,'🍄'),
